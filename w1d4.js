...
function car(make, year, color, brake, acceleration, maxSpeed, minSpeed){
  var speed = 0
  return {
    make: make,
    year: year,
    ...
    maxSpeed: maxSpeed,
    minSpeed: minSpeed,
    joinCar: function(){return "This car is a " + this.year + " " + this.make + " and the color is " + this.color + "!"},
    ...
    brakeFail: function(){
      if(speed <= 6){
        ...
        var brake = Math.random() * this.getSpeed()/2
        speed = speed - brake
      }
    }
  }
...
var newJoinedCar = car("Toyota", "2018", "Black", -7, 10, 85, 0)
newJoinedCar.getSpeed()
newJoinedCar.joinCar()

while(newJoinedCar.getSpeed() < newJoinedCar.maxSpeed){
  newJoinedCar.accelerate()
  console.log("The cars speed is " + newJoinedCar.getSpeed() + " mph!");
}

while(newJoinedCar.getSpeed() > newJoinedCar.minSpeed){
  newJoinedCar.brake()
  console.log("The cars speed is "  + newJoinedCar.getSpeed() + " mph!");
}
